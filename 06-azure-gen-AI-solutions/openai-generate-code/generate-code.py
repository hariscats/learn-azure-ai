    ...
    try: 
        ...
        while True:
            ...
            if command == '1' or command == '2':
                file_path = os.path.join(dir_path, "example-code", "func.py")
                file = open(file=file_path, encoding="utf8").read()                
            elif command =='3':
                file_path = os.path.join(dir_path, "example-code", "go-fish.py")
                file = open(file=file_path, encoding="utf8").read()
            else :
...
def call_openai_model(prompt, model, client):
    ...
    results_file = open(file="result/code.txt", mode="w", encoding="utf8")
